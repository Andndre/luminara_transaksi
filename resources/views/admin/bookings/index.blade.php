...
@section('content')
    <div x-data="{ showModal: false, imgSrc: '' }">
                        ...
                        <tr class="hover:bg-gray-50 transition">
                            ...
                            <td class="py-4 px-6 text-center">
                                @if($booking->payment_proof)
                                    <button @click="showModal = true; imgSrc = '{{ asset('storage/' . $booking->payment_proof) }}'" type="button" class="text-blue-500 hover:text-blue-700 transition" title="Lihat Bukti Transfer">
                ...
                <div class="p-4 space-y-3">
                    ...
                    <div class="flex items-center justify-between pt-2 border-t border-gray-50">
                        <div class="flex gap-3">
                            @if($booking->payment_proof)
                                <button @click="showModal = true; imgSrc = '{{ asset('storage/' . $booking->payment_proof) }}'" class="text-blue-500 text-xs flex items-center gap-1 font-medium">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"></path></svg>
                                    Bukti TF
                                </button>
                            @endif
                            <a href="https://wa.me/{{ preg_replace('/^0/', '62', $booking->customer_phone) }}" class="text-green-600 text-xs flex items-center gap-1 font-medium">
                        ...
                        <div class="flex gap-4">
                            ...
                            <form action="{{ route('admin.bookings.destroy', $booking->id) }}" method="POST" onsubmit="return confirm('Hapus?');">
                                @csrf
                                @method('DELETE')
        ...
        <div x-show="showModal" class="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black bg-opacity-75" style="display: none;"
            ...
            <div class="relative bg-white rounded-lg shadow-xl max-w-3xl w-full max-h-[90vh] flex flex-col" @click.away="showModal = false">
