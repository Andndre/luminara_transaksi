        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
            <div class="p-6 border-b border-gray-100 flex flex-col md:flex-row justify-between items-start gap-4">
                ...
                <div class="flex items-center gap-2 w-full md:w-auto">
                    ...
                    <form action="{{ route('admin.packages.destroy', $package->id) }}" method="POST" class="flex-1 md:flex-none">
                        @csrf
                        @method('DELETE')
                        <button type="button" onclick="confirmDelete(this)" class="w-full justify-center flex items-center gap-1.5 bg-red-50 text-red-700 hover:bg-red-100 px-3 py-2 rounded-xl text-xs font-bold transition shadow-sm border border-red-100">
